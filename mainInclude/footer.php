 ...
 <footer class="container-fluid bg-dark text-center p-2">
    <small class="text-white">Copyright &copy; 2023 || Designed By KK || <?php   
          ...
          <div class="modal-body">
            <form role="form" id="stuLoginForm">
              <div class="form-group">
                ...
                <div class="form-group">
                  <i class="fas fa-key"></i><label for="stuLogPass" class="pl-2 font-weight-bold">Password</label><small id="statusLogMsg2"><input type="password"
