...
<html lang="en">
  <head>
    ...
    <title>InfiLearn</title>
  </head>
  <body>
     <!-- Start Nagigation -->
  
    <nav class="navbar navbar-expand-sm navbar-dark pl-5 fixed-top">
      <a href="index.php" class="navbar-brand">InfiLearn</a>
        ...
        <ul class="navbar-nav pl-5 custom-nav">
          ...
          <?php 
              ...
              if (isset($_SESSION['is_login'])){
                ...
                echo '<li class="nav-item custom-nav-item login"><a href="#login" class="nav-link" data-toggle="modal" data-target="#stuLoginModalCenter">Login</a></li> <li class="nav-item custom-nav-item signup"><a href="#signup" class="nav-link" data-toggle="modal" data-target="#stuRegModalCenter">Signup</a></li>';
              }
          ?> 
          ...
          <?php
              session_start();   
              if (isset($_SESSION['is_login'])){
                echo '<li class="nav-item custom-nav-item"><a href="student/cart.php" class="nav-link">Cart</a></li>';
              }// } else {
