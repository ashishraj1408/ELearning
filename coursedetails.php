                ...
                <div class="col-md-8">
                  <div class="card-body">
                    ...
                    <form action="checkout.php" method="post">
                      ...
                      <button type="submit" class="btn btn-primary text-white font-weight-bolder float-right me-5 mt-4" name="buy">Buy Now</button>
                    </form>
                    <form action="student/cart.php" method="post">
                    <button type="submit" class="btn btn-danger text-white font-weight-bolder float-right me-3 mb-4" name="cart">Add to Cart</button>
                    </form>
                  </div>
                </div>
              ';
